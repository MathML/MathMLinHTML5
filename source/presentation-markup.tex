...
The present specification assumes that $W,w,a,b,A,B$, italic correction
...
This specification does define any layout algorithm for the {\tt mglyph}
element. User agents may just ignore it.

\subsubsection{Identifier {\tt <mi>}}
...
``Vertical Stretching Rules'' of \cite{MathML3}.
Use the {\tt AxisHeight\lxAddClass{MATH}} value as the math axis.
...
Add figure for the vertical alignment \lxAddClass{issue}
