...
\subsection{Operator, Fence, Separator or Accent {\tt <mo>}}\label{Operators}
...
{\tt SubscriptShiftDown\lxAddClass{MATH}}
and is increased until the shift {\tt SubTopShift} for the top of the subscript
is at least {\tt SubscriptTopMax\lxAddClass{MATH}}. When determining
...
{\tt SuperscriptShiftUpCramped\lxAddClass{MATH}} otherwise
it is set to {\tt SuperscriptShiftUp\lxAddClass{MATH}}.
{\tt SuperShift} is increased until the shift for the bottom of the superscript
{\tt SuperBottomShift} is at least
{\tt SuperscriptBottomMin\lxAddClass{MATH}}. When determining
the logical box, a space of width {\tt SpaceAfterScript\lxAddClass{MATH}}
is added after
...
{\tt SubShift} is initially set to {\tt SubscriptShiftDown\lxAddClass{MATH}}.
If the {\tt msubsup} element is cramped (section \ref{LaTeX}) then
{\tt SuperShift} must be at least
{\tt SuperscriptShiftUpCramped\lxAddClass{MATH}} otherwise
it must be at least {\tt SuperscriptShiftUp\lxAddClass{MATH}}
(see section \ref{LaTeX}).
{\tt SupShift} is increased until the shift for the bottom of the superscript
{\tt SupBottomShift} is at least {\tt SuperscriptBottomMin\lxAddClass{MATH}}.
