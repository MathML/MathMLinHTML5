...
and is increased to ensure that the shift {\tt SubTopShift} for the top of the
subscript is at least {\tt SubscriptTopMax\lxAddClass{MATH}}.

\href{https://github.com/MathML/MathMLinHTML5/issues/8}{Need to describe SubscriptBaselineDropMin and add it on the schema} \lxAddClass{issue}
...
{\tt SuperShift} is increased to ensure that the shift for the bottom of the
superscript {\tt SuperBottomShift} is at least
{\tt SuperscriptBottomMin\lxAddClass{MATH}}.

\href{https://github.com/MathML/MathMLinHTML5/issues/8}{Need to describe SuperscriptBaselineDropMax and add it on the schema} \lxAddClass{issue}
...
\href{https://github.com/MathML/MathMLinHTML5/issues/8}{Need to describe SubscriptBaselineDropMin and SuperscriptBaselineDropMax and add them on the schema} \lxAddClass{issue}
...
{\tt SupShift} is increased to ensure the shift for the bottom of the
superscript {\tt SuperBottomShift} is at least {\tt SuperscriptBottomMin\lxAddClass{MATH}}.
